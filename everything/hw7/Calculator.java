...
/**
 * REMOVED IMPLEMENT ACTION LISTENER
 */
class Calculator {

    /**
    * Implements J objects that will be defines within calculator()
    */
    JFrame f;
    JTextField t;
    ...
    /**
    * main function of this program that does all button defining and actions
    */
    Calculator() {
        ...
        */
        ...
        /**
        * Merged action listener and action performer instead of action performer
        * being used in a seperate class. All implementations are performed 
        * within the listener definition. pretty cool
        */
